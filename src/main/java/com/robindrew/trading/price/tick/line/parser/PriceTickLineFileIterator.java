...
public class PriceTickLineFileIterator implements Iterator<IPriceTick>, AutoCloseable {

	private static BufferedReader createReader(File file, IPriceTickLineParser parser) {
		try {
	...
	private IPriceTick tick = null;

	public PriceTickLineFileIterator(File file, IPriceTickLineParser parser) {
