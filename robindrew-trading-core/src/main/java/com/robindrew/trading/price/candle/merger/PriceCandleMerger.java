...
public class PriceCandleMerger {
    ...
    public IPriceCandle merge(IPriceCandle candle1, IPriceCandle candle2) {
        ...
        if (bidOpenPrice == askOpenPrice
                && bidClosePrice == askClosePrice
                && bidHighPrice == askHighPrice
                && bidLowPrice == askLowPrice) {
    ...
    public IPriceCandle merge(Collection<? extends IPriceCandle> candles) {
        ...
        return new MidPriceCandle(
                openPrice, highPrice, lowPrice, closePrice, openTime, closeTime, decimalPlaces, tickVolume);
    }
}
