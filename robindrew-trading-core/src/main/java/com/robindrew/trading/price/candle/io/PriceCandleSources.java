...
public class PriceCandleSources {
    ...
    public static void writeCandlesToDataFile(File toFile, List<IPriceCandle> candleList) {
        ...
        try (IPriceCandleListSink sink = new PriceCandleListToStreamSink(
                createFileDataSink(toFile, new PriceCandleDataSerializer(decimalPlaces)))) {
    ...
    public static List<IPriceCandle> readStreamToSortedList(IPriceCandleStreamSource stream) {
        ...
        try (IPriceCandleListSource list = new PriceCandleListFilteredSource(
                new PriceCandleStreamToListSource(stream), new PriceCandleListSortedFilter())) {
    ...
    public static List<IPriceCandle> readCandlesFromDataFile(File fromFile, int decimalPlaces) {
        try (PriceCandleDataStreamSource stream =
                createLineSource(fromFile, new PriceCandleDataSerializer(decimalPlaces))) {
