...
import com.robindrew.trading.util.io.Files;
...
public class JFreePriceCandleChartBuilder implements IPriceCandleChartBuilder {
    ...
    public static void main(String[] args) {
        ...
        File directory =
                new File("C:\\development\\repository\\git\\robindrew-public\\robindrew-trading-data\\data\\pcf");
        ...
        IPriceCandleStreamSource stream =
                new PriceCandleStreamSourceBuilder().setPcfSources(sources).get();
