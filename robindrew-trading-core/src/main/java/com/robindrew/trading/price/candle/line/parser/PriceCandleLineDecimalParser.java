...
import com.robindrew.trading.util.text.CharDelimiters;
import com.robindrew.trading.util.text.CharTokenizer;
import java.nio.charset.Charset;
import java.time.LocalDateTime;

public class PriceCandleLineDecimalParser implements IPriceCandleLineParser {

    public static final CharDelimiters DELIMITERS =
            new CharDelimiters().whitespace().character(',');
    ...
    public IPriceCandle parseCandle(String line) {
        ...
        return new MidPriceCandle(
                open, high, low, close, toMillis(openDate), toMillis(closeDate), decimalPlaces, tickVolume);
    }
