...
public abstract class LatestPriceTradingStrategy<I extends ITradingInstrument> extends AbstractTradingStrategy<I>
        implements ILatestPriceTradingStrategy<I> {
