...
public class DecimalTest {
    ...
    private static void testToInt(int expected, int value, int decimalPlaces) {
        Assertions.assertEquals(expected, Decimals.decimalToInt(value, decimalPlaces));
    }
    ...
    private static void testToString(String expected, int value, int decimalPlaces) {
        ...
        Assertions.assertEquals(bigDecimal, intDecimal);
    }
    ...
    private static void testFromBigDecimal(Decimal decimal, String textValue) {
        ...
        Assertions.assertEquals(decimal, new Decimal(value));
    }
